...
sleep 1
echo $line
echo "         ...8, 16, 200, 220, 240, 275 MB"
echo $line
echo ""
sleep 1
echo 2048,4096,51200,56320,61440,70400 > /sys/module/lowmemorykiller/parameters/minfree
echo 2048,4096,51200,56320,61440,70400 > /data/V6_SuperCharger/SuperChargerMinfree
...
echo ""
sleep 1
sed -i 's/MFK=.*/MFK=40960;/' /system/etc/init.d/*SuperCharger* 2>/dev/null
sed -i 's/MFK=.*/MFK=40960;/' /data/99SuperCharger.sh 2>/dev/null
sed -i 's/MFK=.*/MFK=40960;/' /system/xbin/99super 2>/dev/null
